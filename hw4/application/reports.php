...
ORDER BY COUNT(fname), COUNT(lname) DESC
LIMIT 1";

// iii. List the name of the customer that has ordered the most cookies.
// Note, this query is a bit different from the previous query as we are
// counting cookies not orders.
$query = "SELECT fname, lname FROM customer
